...
Part 1 of the SM Profile effort is aligned with OPC UA Information Models (Part 5 of the UA Specification). Examples of these Information Models can be found here:
